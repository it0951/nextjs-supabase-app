...
- 상세한 기술 스택과 용도별 분류
- **반드시 최신 버전 명시**: Next.js 16, React 19.2.4 등
...
- **React 19.2.4** - UI 라이브러리 (최신 동시성 기능)
...
6. **최신 기술**: **반드시 현재 최신 버전** 명시 (Next.js 16, React 19.2.4 등)

## 🔧 기술 스택 선택 원칙

- **최신 버전 필수**: Next.js 16, React 19.2.4, TailwindCSS v4 등 최신 버전 사용
- **Next.js 16 기반**: 최신 App Router, 향상된 성능, React 19.2.4 지원
