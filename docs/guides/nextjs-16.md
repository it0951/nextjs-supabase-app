# Next.js 16.2.3 개발 지침

이 문서는 Claude Code에서 Next.js 16.2.3 프로젝트를 개발할 때 따라야 할 핵심 규칙과 가이드라인을 제공합니다.
...
이 지침을 따라 Next.js 16.2.3의 모든 기능을 최대한 활용하여 현대적이고 성능 최적화된 애플리케이션을 개발하세요.
